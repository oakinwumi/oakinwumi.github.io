...
module.exports = function(app){
    ...
    app.get('/analysis', function(req, res){
        ...
        var uottawaS = readData("uottawaS");
        var color = readData("color");
        var uicomponent = readData("uicomponent");
        var picture = readData("picture");
        var rate = readData("rate");
        var name = readData("name");
        // var uottawaS = readData("uottawaF");
        res.render('showResults', {results: [uottawaS,color,uicomponent,picture,rate,name]});
    ...
    app.post('/niceSurvey', urlencodedParser, function(req, res){
        ...
        for (var key in json){
            ...
            if ((key === "uicomponent") && (json[key].length === 2)){
